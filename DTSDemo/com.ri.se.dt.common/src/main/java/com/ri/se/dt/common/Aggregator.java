...
public class Aggregator {
	...
	public ExtractedValues recR1(String json, String username, String password) throws Exception {
	...
	public String sndR2(String subDid, String clientEtherAddress, String etherURL, String dapAddress, String walletDir,
