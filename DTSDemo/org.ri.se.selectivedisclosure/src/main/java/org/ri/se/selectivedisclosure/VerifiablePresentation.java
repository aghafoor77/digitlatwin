...
public class VerifiablePresentation {
	...
	public Map<String, Object> getClaims() {
		...
		Map<String, Object> presentation = (Map<String, Object>) map.get("presentation");
		Map<String, Object> claims = (Map<String, Object>) presentation.get("claims");
		return claims;
	}
	...
	public String getPresentationDate() {
		Map<String, Object> proof = (Map<String, Object>)getJsonObject().get("proof");
		String presentationDate = proof.get("created").toString();
		return presentationDate;
	}
	public String getVerifiableCredentialDate() {
		Map<String, Object> presentation = (Map<String, Object> ) getJsonObject() .get("presentation");
		Map<String, Object> vcProof = (Map<String, Object>) presentation.get("proof");
		String vcDate = vcProof.get("created").toString();
		return vcDate;
	}
