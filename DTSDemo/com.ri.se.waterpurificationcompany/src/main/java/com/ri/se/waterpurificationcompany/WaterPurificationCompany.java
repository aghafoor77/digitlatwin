package com.ri.se.waterpurificationcompany;
...
public class WaterPurificationCompany {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String reqFile : vcs) {
			...
			/*
			 * Iterator<String> i = claims.keySet().iterator(); while (i.hasNext()) {
		...
		System.out.println("WPC Total Records :" + vcs.size() + " " + presenOpenStart + " " + presenOpenEnd + " = "
				+ (presenOpenEnd - presenOpenStart));
	}
	...
	public void execute() throws Exception {
		...
		long presenOpenEnd = System.currentTimeMillis();
		System.out.println("WPC : " + vcs.size() + " " + presenOpenEnd + " - " + presenOpenStart + " = "
				+ (presenOpenEnd - presenOpenStart));
		write("WPC : " + vcs.size() + " " + presenOpenEnd + " - " + presenOpenStart + " = "
				+ (presenOpenEnd - presenOpenStart));
	}

	public void write(String text) throws IOException {
		text = text + "\n";
		String path = "/home/ag/Desktop/DTSDDemo/results/wpc.txt";
	...
	public static void writeFile(String title ,String text) throws IOException {
		text=text+"\n";
		 String path = "/home/ag/Desktop/DTSDDemo/results/citizenVP.txt";
		 if(!new File(path).exists()) {
			 new File(path).createNewFile();
		 }
	...
	public static Map<String, Object> openResponse(String vcms) throws Exception {
		...
		writeFile("WaterPurificationVP",vcStr);
